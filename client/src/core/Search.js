...
const Search = () => {
  ...
  const searchForm = () => (
    <form onSubmit={searchSubmit} className={classes.root}>
        ...
        <div  style={{background:'white',borderRadius:'10px',display:'flex',justifyContent:'space-evenly',width:'100%',padding:'10px',border:'solid'}}>
          ...
          <div className='ml-3 mt-2' style={{ border: 'none' }}>
            <Button ml={2} variant='contained' type='submit' style={{background:'black',color:'white'}}>
              Search
            </Button>
          </div>
        </div>
